...
class HabitAdapter(
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            val priority = itemView.resources.getStringArray(R.array.priority_level)
            when(habit.priorityLevel){
                priority[0]-> ivPriority.setImageDrawable(ContextCompat.getDrawable(itemView.context,R.drawable.ic_priority_high))
                priority[1]-> ivPriority.setImageDrawable(ContextCompat.getDrawable(itemView.context,R.drawable.ic_priority_medium))
                else-> ivPriority.setImageDrawable(ContextCompat.getDrawable(itemView.context,R.drawable.ic_priority_low))
            }
