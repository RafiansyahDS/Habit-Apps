...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            when(pageType){
                PageType.HIGH ->ivPriority.setImageDrawable(ContextCompat.getDrawable(itemView.context, R.drawable.ic_priority_high))
                PageType.MEDIUM->ivPriority.setImageDrawable(ContextCompat.getDrawable(itemView.context, R.drawable.ic_priority_medium))
